...
# installed.
TCL_PREFIX='g:/Work_code/aiogram_bot/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='g:/Work_code/aiogram_bot/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='g:/Work_code/aiogram_bot/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Ig:/Work_code/aiogram_bot/.conda\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Lg:/Work_code/aiogram_bot/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='g:/Work_code/aiogram_bot/.conda\Library\lib\tclstub86.lib'
